const querydata = [
  ...
  },
  {
    ...
    query: `SELECT * FROM (
      SELECT
          ...
          md.departement AS english_name,
          md.position,
          'DEPARTMENT' AS type,
  ...
  },
  {
    ...
    CASE when mt.alias_code = 'null' then NULL else mt.alias_code end as alias_code, 
    mt.uid as local_code, 
    mt.test_name as name,
    mt.test_name as english_name, 
    lu.unit, 
  ...
  },
  {
    ...
    mtp.panel_name AS english_name,
    (SELECT COALESCE(
...
ORDER BY mt.position ASC;`,
  },
  {
    ...
    ELSE 'YEAR'
    END AS age_max_unit,
    CASE WHEN l.sign_male = '' then l.sign_unspecified else l.sign_male end as sign_male, 
    CASE WHEN l.male_normal_value = 0 THEN l.unspecified_normal_value else l.male_normal_value end as male_value, 
    CASE WHEN l.sign_female = '' then l.sign_unspecified else l.sign_female end as sign_female,
    CASE WHEN l.female_normal_value = 0 THEN l.unspecified_normal_value else l.female_normal_value end as female_value,
    l.sign_unspecified, 
